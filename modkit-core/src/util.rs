...
pub fn get_query_name_string(record: &bam::Record) -> MkResult<String> {
...
impl GenomeRegion {
    ...
    pub fn parse_unstranded_bed_line(line: &str) -> anyhow::Result<Self> {
