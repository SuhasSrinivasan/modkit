...
mod tests {
    ...
    use super::{
        ...
        QueryNameOrder, RecordPair, RepairJob, RepairSlot,
    };
    ...
    #[test]
    fn repair_reports_a_shorter_donor_sequence_correctly() {
        assert!(repair("ACG", "ACGT")
            .unwrap_err()
            .to_string()
            .contains("donor sequence for read is shorter"));
    }
}
